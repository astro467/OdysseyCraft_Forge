...
public enum ModArmorMaterials implements ArmorMaterial {
    INCIDIUM("incidium", 75, new int[]{3, 6, 8, 3}, 37, SoundEvents.ARMOR_EQUIP_NETHERITE, 6.0F, 0.2F, () -> {
        return Ingredient.of(ModItems.INCIDIUM_INGOT.get());
    });
    ...
    public String getName() {
        return OdysseyCraft.MOD_ID + ":" + this.name;
    }
